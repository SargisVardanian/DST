...
DEFAULT_RULE_DIR = THIS_DIR / "results" / "raw_runs" / "rules"

# Current repo format (DSModelMultiQ.save_rules_dsb):
...
def write_rule_counts_csv(
    input_dir: str | Path = DEFAULT_RULE_DIR,
    pattern: str = "*.dsb",
    ...
    Args:
        input_dir (str | Path): Directory containing .dsb files. Default: 'results/raw_runs/rules'
...
if __name__ == "__main__":
    ...
    p.add_argument("--input-dir", default=str(DEFAULT_RULE_DIR))
