...
The CLI below is a secondary terminal-facing inspection utility.
Modes:
...
def predict_sample(
    *,
    ...
    if comb == "vote":
        ...
        pred = np.asarray(clf.predict(batch, combination_rule=comb), dtype=int)
...
def main() -> None:
    ...
    parser.add_argument("--out-root", default=str(COMMON / "results"))
